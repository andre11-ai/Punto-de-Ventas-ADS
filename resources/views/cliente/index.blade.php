            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="tblClients" class="table table-striped table-hover display responsive nowrap" width="100%">
                            <thead class="thead">
                                <tr>
                                    <th><i class="fas fa-hashtag me-1"></i>ID</th>
                                    <th><i class="fas fa-user me-1"></i>Nombre</th>
                                    <th><i class="fas fa-phone me-1"></i>Teléfono</th>
                                    <th><i class="fas fa-dollar-sign me-1"></i>Total de la compra</th>
                                    <th><i class="fas fa-calendar-day me-1"></i>Días sin pagar</th>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function () {
            const tabla = new DataTable('#tblClients', {
                processing: true,
                serverSide: true,
